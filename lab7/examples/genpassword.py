...
def genpassword(wlc, maxchar, txt, List, verbose):
    word = ""
    i1 = i2 = i3 = i4 = i5 = i6 = i6 = i8 = i9 = i10 = i11 = i12 = i13 = i14 = i15 = 0
    txtfile = open(txt, 'w')
                                                            ...
                                                            for i15 in range(len(wlc)):
                                                                ...
                                                                if int(maxchar) == 9:
                                                                    word = wlc[i7] + wlc[i8] + wlc[i9] + wlc[i10] \
                                                                           + wlc[i11] + wlc[i12] + wlc[i13] + wlc[i14] + \
                                                                           wlc[i15]
                                                                if int(maxchar) == 10:
                                                                ...
                                                                if int(maxchar) == 11:
                                                                    word = wlc[i5] + wlc[i6] + wlc[i7] + wlc[i8] \
                                                                           + wlc[i9] + wlc[i10] + wlc[i11] + wlc[i12] + \
                                                                           wlc[i13] \
                                                                           + wlc[i14] + wlc[i15]
                                                                if int(maxchar) == 12:
                                                                    word = wlc[i4] + wlc[i5] + wlc[i6] + wlc[i7] + wlc[
                                                                        i8] \
                                                                           + wlc[i9] + wlc[i10] + wlc[i11] + wlc[i12] + \
                                                                           wlc[i13] \
                                                                           + wlc[i14] + wlc[i15]
                                                                if int(maxchar) == 13:
                                                                    word = wlc[i3] + wlc[i4] + wlc[i5] + wlc[i6] \
                                                                           ...
                                                                           + wlc[i14] + wlc[i15]
                                                                if int(maxchar) == 14:
                                                                    word = wlc[i2] + wlc[i3] + wlc[i4] + wlc[i5] + wlc[
                                                                        i6] \
                                                                           + wlc[i7] + wlc[i8] + wlc[i9] + wlc[i10] \
                                                                           + wlc[i11] + wlc[i12] + wlc[i13] \
                                                                           + wlc[i14] + wlc[i15]
